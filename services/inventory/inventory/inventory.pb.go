...
type GetPreInventoryReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int32                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`              // 按用户查询
	PreOrderId    string                 `protobuf:"bytes,2,opt,name=pre_order_id,json=preOrderId,proto3" json:"pre_order_id,omitempty"` // 按预订单号查询
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetPreInventoryReq) Reset() {
	*x = GetPreInventoryReq{}
	mi := &file_inventory_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPreInventoryReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPreInventoryReq) ProtoMessage() {}

func (x *GetPreInventoryReq) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPreInventoryReq.ProtoReflect.Descriptor instead.
func (*GetPreInventoryReq) Descriptor() ([]byte, []int) {
	return file_inventory_proto_rawDescGZIP(), []int{3}
}

func (x *GetPreInventoryReq) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetPreInventoryReq) GetPreOrderId() string {
	if x != nil {
		return x.PreOrderId
	}
	return ""
...
type GetPreInventoryResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Records       []*PreInventoryRecord  `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetPreInventoryResp) Reset() {
	*x = GetPreInventoryResp{}
	mi := &file_inventory_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPreInventoryResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPreInventoryResp) ProtoMessage() {}

func (x *GetPreInventoryResp) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPreInventoryResp.ProtoReflect.Descriptor instead.
func (*GetPreInventoryResp) Descriptor() ([]byte, []int) {
	return file_inventory_proto_rawDescGZIP(), []int{5}
}

func (x *GetPreInventoryResp) GetRecords() []*PreInventoryRecord {
	if x != nil {
		return x.Records
	}
	return nil
...
var file_inventory_proto_rawDesc = []byte{
	...
	,
	...
	0x4e, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x72, 0x65, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x37, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74,
	0x6f, 0x72, 0x79, 0x2e, 0x50, 0x72, 0x65, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22,
	0x4f, 0x0a, 0x0d, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70,
	...
	0x22, 0x8f, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72,
	...
	,
	...
	0x70, 0x12, 0x49, 0x0a, 0x14, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x50, 0x72, 0x65,
	...
	0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x46, 0x0a, 0x11,
	0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72,
	0x79, 0x12, 0x17, 0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x49, 0x6e,
	...
	0x52, 0x65, 0x73, 0x70, 0x12, 0x47, 0x0a, 0x12, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x50, 0x72,
	...
	0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x44, 0x0a,
	0x0f, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79,
...
var file_inventory_proto_goTypes = []any{
	...
	(*GetPreInventoryReq)(nil),   // 3: inventory.GetPreInventoryReq
	(*PreInventoryRecord)(nil),   // 4: inventory.PreInventoryRecord
	(*GetPreInventoryResp)(nil),  // 5: inventory.GetPreInventoryResp
	(*InventoryResp)(nil),        // 6: inventory.InventoryResp
	(*GetInventoryResp)(nil),     // 7: inventory.GetInventoryResp
	(*InventoryReq_Items)(nil),   // 8: inventory.InventoryReq.Items
}
var file_inventory_proto_depIdxs = []int32{
	8, // 0: inventory.InventoryReq.items:type_name -> inventory.InventoryReq.Items
	4, // 1: inventory.GetPreInventoryResp.records:type_name -> inventory.PreInventoryRecord
	1, // 2: inventory.Inventory.GetInventory:input_type -> inventory.GetInventoryReq
	3, // 3: inventory.Inventory.GetPreInventory:input_type -> inventory.GetPreInventoryReq
	0, // 4: inventory.Inventory.UpdateInventory:input_type -> inventory.InventoryReq
	0, // 5: inventory.Inventory.DecreasePreInventory:input_type -> inventory.InventoryReq
	0, // 6: inventory.Inventory.DecreaseInventory:input_type -> inventory.InventoryReq
	0, // 7: inventory.Inventory.ReturnPreInventory:input_type -> inventory.InventoryReq
	0, // 8: inventory.Inventory.ReturnInventory:input_type -> inventory.InventoryReq
	7, // 9: inventory.Inventory.GetInventory:output_type -> inventory.GetInventoryResp
	5, // 10: inventory.Inventory.GetPreInventory:output_type -> inventory.GetPreInventoryResp
	6, // 11: inventory.Inventory.UpdateInventory:output_type -> inventory.InventoryResp
	6, // 12: inventory.Inventory.DecreasePreInventory:output_type -> inventory.InventoryResp
	6, // 13: inventory.Inventory.DecreaseInventory:output_type -> inventory.InventoryResp
	6, // 14: inventory.Inventory.ReturnPreInventory:output_type -> inventory.InventoryResp
	6, // 15: inventory.Inventory.ReturnInventory:output_type -> inventory.InventoryResp
